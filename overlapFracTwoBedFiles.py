...
Usage:  ~/myEnv/bin/python ~arushiv/toolScripts/overlapFracTwoBedFiles.py a.bed b.bed""")
    ...
    print nameFile1, lengthFile1, nameFile2, lengthFile2, lengthIntersect, lengthIntersect/lengthFile1  # getname(args.bedfile1), lengthOfBedFile(bedfile1), getname(args.bedfile2), lengthOfBedFile(bedfile2), lengthOfBedFile(intersect)
